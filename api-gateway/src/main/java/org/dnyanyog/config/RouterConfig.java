...
public class RouterConfig {
    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                .route("directory-service", r -> r.path("/api/v1/auth/user/**").uri("http://localhost:8081"))
                ...
                .route("appointment-service", r -> r.path("/api/v1/appointment/**").uri("http://localhost:8084"))
                .build();
    }
}
